...
const UserPage = ({ updateOrders }) => {
  ...
  return <Main>
    <Container className={styles.container}>
      <MetaTags>
        <title>{user ? `${user.first_name} ${user.last_name}` : 'Users recipes'}</title>
        <meta name="description" content={user ? `Foodgram - ${user.first_name} ${user.last_name}` : 'Foodgram - Users recipes'} />
        <meta property="og:title" content={user ? `${user.first_name} ${user.last_name}` : 'Users recipes'} />
      </MetaTags>
