# Generated by Django 4.1.2 on 2022-11-21 20:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ImageField(help_text='Upload your image', upload_to='recipes/images', verbose_name='Image')),
                ('text', models.TextField(help_text='Type your recipe', verbose_name='Text')),
                ('cooking_time', models.PositiveIntegerField(help_text='Enter cooking time for your recipe', validators=[django.core.validators.MinValueValidator(1, message='Cooking time should be more than 0!')], verbose_name='Cooking time')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('amount', models.PositiveSmallIntegerField(default=1, help_text='Add how much of ingredient you need for your recipe', validators=[django.core.validators.MinValueValidator(1, message='Amount of ingredient should be more than 0!')], verbose_name='Ingredient amount')),
